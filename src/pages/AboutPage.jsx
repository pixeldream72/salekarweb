  ...
  return (
    <section className="page-card">
      ...
      <p style={{ fontSize: '1.05rem', marginTop: '1rem' }}>
        {tenant.businessName} is a{' '}
        {tenant.businessType?.toLowerCase() || 'wholesale'} business
        {tenant.city ? ` based in ${tenant.city}` : ''}, committed to
        offering quality products and reliable service to our customers.
      </p>
        ...
        <article className="info-card">
          ...
          <p style={{ color: '#64748b' }}>
            {tenant.what_we_offer ||
              'A wide range of wholesale-ready products with bulk-friendly pricing, easy quotation requests, and fast turnaround for repeat orders.'}
          </p>
        </article>
